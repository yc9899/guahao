						...
						<div class="portlet-body form">
							...
							<form  method="post" class="form-horizontal" id="defaultForm">
								...
								<div class="form-body">
										...
										<label class="control-label col-md-3" for="inputWarning">旧密码</label>
										<div class="col-md-4">
                                                                                     <input type="text" name="pass" class="form-control" id="inputError"/>
									...
									<div class="form-group has-success">
										...
										<div class="col-md-4">
											<input type="password" name="xin" class="form-control" id="inputError"/>
											
										</div>
									</div>
									<div class="form-group has-success">
										<label class="control-label col-md-3" for="inputSuccess">重复密码：</label>
										<div class="col-md-4">
										     <input type="password" name="xinpass" class="form-control" id="inputError"/>
