						...
						<div class="portlet-body form">
							...
							<form  method="post" class="form-horizontal">
								...
								<div class="form-body">
										...
										<label class="control-label col-md-3" for="inputWarning">科室名称</label>
										<div class="col-md-4">
                                                                                     <input type="hidden" name="id" value="<?php echo ($list["id"]); ?>">
                                                                                     <input type="text" name="mingcheng" class="form-control" id="inputError" value="<?php echo ($list["dname"]); ?>"/>
