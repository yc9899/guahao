						...
						<div class="portlet-body form">
							...
							<form  method="post" class="form-horizontal">
								...
								<div class="form-body">
										...
										<label class="control-label col-md-3" for="inputWarning">用户组名</label>
										<div class="col-md-4">
                                                                                     <input type="text" name="yonghu" class="form-control" id="inputError"/>

										</div>
									</div>

                                                                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="form-group has-success">
										<label class="control-label col-md-3" for="inputError">权限选择</label>
	  
										<div class="col-md-4">
										   
                                                                          <input type="checkbox" name="checkbox[]" value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?> | <?php echo ($vo["name"]); ?>
