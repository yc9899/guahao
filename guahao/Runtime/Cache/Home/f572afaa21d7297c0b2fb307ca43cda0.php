							...
							<form  method="post" class="form-horizontal">
								...
								<div class="form-body">
									...
									<div class="form-group has-success">
										<label class="control-label col-md-3" for="inputError">密码</label>
										<div class="col-md-4">
											<input type="password" name="mima" class="form-control" id="inputError"/>
											
										</div>
									</div>
									<div class="form-group has-success">
										<label class="control-label col-md-3" for="inputSuccess">权限</label>
										<div class="col-md-4">
											<select name="quanxian" class="form-control">
