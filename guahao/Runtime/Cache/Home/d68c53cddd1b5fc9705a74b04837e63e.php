		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="/Home/Yuyue/lists/">报备管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="#">详细信息</a>
						...
						<div class="portlet-title">
							...
							<ul class="list-group">
								...
								<li class="list-group-item">
									...
									姓名： <?php echo ($list["name"]); ?>

								</li>

								<li class="list-group-item">

									 性别：<?php echo ($list["gender"]); ?>

								</li>

								<li class="list-group-item">

									 联系电话:<?php echo ($list["telephone"]); ?>

								</li>

								<li class="list-group-item">

									 录入时间:<?php echo ($list["date"]); ?>

                          					</li>
                                                           <li class="list-group-item">

                                                                         预约时间:<?php echo ($list["yydate"]); ?>
								...
								<li class="list-group-item">
									 ...
									 是否到院：<?php echo ($list["yuyue"]); ?>

								</li>
								<li class="list-group-item">

									 是否手术：<?php echo ($list["surgery"]); ?>

								</li>
								<li class="list-group-item">

									 地区：<?php echo ($list["address"]); ?>

								</li>
								<li class="list-group-item">

									 到院时间：<?php echo ($list["todate"]); ?>

								</li>
								<li class="list-group-item">

									 备注：<?php echo ($list["data"]); ?>
