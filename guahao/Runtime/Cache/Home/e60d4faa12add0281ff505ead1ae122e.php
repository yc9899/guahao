		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a href="/system/setting/">系统基本参数</a>
						</li>
						<li>
						...
						<div class="portlet-body form">
							...
							<form  method="post" class="form-horizontal">
								...
								<div class="form-body">
										...
										<div class="col-md-4">
                                                                                     <input type="text" name="xingming" class="form-control" id="inputError" value="<?php echo ($list["name"]); ?>"/>
									...
									<div class="form-group has-success">
										...
										<div class="col-md-4">
											<input type="radio" name="xingbie" id="optionsRadios2" value="男" <?php if($list["gender"] == 男): ?>checked<?php endif; ?> >男
                                                                                        <input type="radio" name="xingbie" id="optionsRadios2" value="女"  <?php if($list["gender"] == 女): ?>checked<?php endif; ?> >女
									...
									<div class="form-group has-success">
										...
										<div class="col-md-4">
											<input type="text" name="nianling" class="form-control" id="inputError" value="<?php echo ($list["age"]); ?>"/>
									...
									<div class="form-group has-success">
										...
										<div class="col-md-4">
											<input type="text" name="phone" class="form-control" id="inputSuccess" value="<?php echo ($list["telephone"]); ?>"/>
									...
									<div class="form-group has-success">
										...
										<div class="col-md-4">
											<input type="text" name="yysj" class="form-control" id="inputError" onClick="WdatePicker()" value="<?php echo ($list["yydate"]); ?>"/>
									...
									<div class="form-group has-success">
										...
										<div class="col-md-4">
											<select name="keshi" class="form-control">
                                                                                             <option><?php echo ($list["department"]); ?></option>
                                                                                             <?php if(is_array($dep )): $i = 0; $__LIST__ = $dep ;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option><?php echo ($vo["dname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                                                             </select>
									...
									<div class="form-group has-success">
										...
										<div class="col-md-4">
											<input type="text" name="dz" class="form-control" id="inputError"  value="<?php echo ($list["address"]); ?>"/>
										...
										<label class="control-label col-md-3" for="inputSuccess">备注</label>
                                                                                     <div class="col-md-8">
                	<textarea class="ckeditor form-control" name="ziliao" rows="6" data-error-container="#editor2_error"><?php echo ($list["data"]); ?></textarea>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
                                                                                        <input type="hidden" name="hidd" value="<?php echo ($list["id"]); ?>">
